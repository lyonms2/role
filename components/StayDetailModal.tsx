    ...
    <div className="fixed inset-0 flex flex-col bg-black/60" style={{ zIndex }} onClick={onClose}>
      ...
      {showReview && stay && (
        <WriteStayReviewModal
          ...
          onSubmitted={() => {
            setShowReview(false)
            getStayReviews(stayId).then(setReviews)
          }}
          zIndex={zIndex + 10}
        />
      )}
                  ...
                  <div className="flex items-center justify-between mb-3">
                    ...
                    {user && (
                      <button
                        ...
                        className="text-xs font-bold text-blue-500 border border-blue-200 px-3 py-1.5 rounded-lg hover:bg-blue-50 transition-colors"
                      >
                        + Avaliar
                      </button>
                    )}
