  ...
  if (step === 'idle') {
    return (
      <div className="text-center">
        ...
        <button onClick={() => setStep('form')} className="w-full py-3.5 rounded-xl font-bold text-white text-sm bg-orange-500 hover:bg-orange-600 transition-colors shadow-sm">
